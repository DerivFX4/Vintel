...
// Keep this list empty until an XML bot is deliberately added to the Free Bots library.
// New uploads should be inserted at the top so the newest bot appears first.
